...
<div class="card" id="education-card">
    ...
    <div class="hidden-content">
        <p>
            Jag är en dedikerad webutvecklare med ett brinnande intresse för säkerhetsaspekterna av webbutveckling. Min
            gymnasiearbete om Cross-Site Scripting (XSS) har fördjupat min förståelse för säkerhetshål och vikten av att
            skydda webbapplikationer. Jag älskar att koda och strävar alltid efter att skapa bättre och säkrare
            användarupplevelser online. Om du vill diskutera webbutveckling, säkerhet eller något annat ämne, är du
